import { MembershipInMemoryCacheEntity } from './membership-in-memory-cache.entity';

describe('MembershipInMemoryCacheEntity', () => {
  it('should create an entity with all properties', () => {
    const entity = new MembershipInMemoryCacheEntity(
      '1',
      'g1',
      'u1',
